...
internal static class FarmCatalog
{
    public static readonly ItemConfiguration[] Items = [
        .. new[]{"Urine","Fertilizer","MapleSyrup"}.SelectMany(contents=>new[]{false,true}.Select(jar=>new ItemConfiguration((jar?"jarOf":"bottleOf")+contents,(jar?"Jar":"Bottle")+" of "+(contents=="MapleSyrup"?"maple syrup":contents.ToLowerInvariant()),contents=="Urine"?"Craft into potassium nitrate at a crafting table":contents=="MapleSyrup"?"Decant at a stove for maple syrup servings":"Craft into fertilizer for gardens",0,0,10,100,ForSale:false,WeightPounds:jar?6:1.3)))];
    ...
    public static readonly CraftingRecipe[] Recipes = [
        ...
        new("bottleMapleSyrup","Decant bottled maple syrup","mapleSyrup",1,[new("bottleOfMapleSyrup",1)]),
        new("jarMapleSyrup","Decant jar of maple syrup","mapleSyrup",5,[new("jarOfMapleSyrup",1)]),
