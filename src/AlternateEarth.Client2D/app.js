(() => {
  ...
  const ui = {
    ...
    center: $('#centerButton'), god: $('#godMode'), rebuild: $('#rebuildButton'), inventory: $('#inventoryItems'), flashlight:$('#flashlightToggle'), lantern:$('#lanternToggle'),laser:$('#laserToggle'),
  ...
  function syncLightControls(me){if(!me)return;ui.flashlight.checked=!!me.flashlightOn;ui.lantern.checked=!!me.lanternOn;ui.laser.checked=!!me.laserOn;}
