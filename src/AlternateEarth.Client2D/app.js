(() => {
  ...
  const ui = {
    ...
    center: $('#centerButton'), god: $('#godMode'), rebuild: $('#rebuildButton'), inventory: $('#inventoryItems'), flashlight:$('#flashlightToggle'), lantern:$('#lanternToggle'),laser:$('#laserToggle'), shoes:$('#magicHikingShoesToggle'),
  ...
  function render(now) {
    ...
    drawProjectiles(now);
    drawAtmosphere(me,detail,now);drawLaser(me);
  ...
  function syncLightControls(me){if(!me)return;ui.flashlight.checked=!!me.flashlightOn;ui.lantern.checked=!!me.lanternOn;ui.laser.checked=!!me.laserOn;ui.shoes.checked=!!me.magicHikingShoesOn;}
  ...
  ui.shoes.addEventListener('change',()=>send({type:'setMagicHikingShoes',enabled:ui.shoes.checked}));
