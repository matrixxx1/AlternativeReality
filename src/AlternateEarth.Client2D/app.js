(() => {
  ...
  const state = {
    ...
    pointer: { down: false, dragged: false, button: null, startX: 0, startY: 0, x: 0, y: 0 }, suppressClick: false, actionPoint: null, actionActor: null, pendingDoor: null, pendingChest: null, pendingGpsTeleport: null, frame: 0, projectiles: [], outdoorFog: new Set(), areaLoading: false, godTogglePending: null
  };
