...
if (!clientScript.includes('drawRaftRider') || !clientScript.includes("mode==='raft'") || !clientScript.includes('quadraticCurveTo'))
  throw new Error('Seated raft rendering or rowing animation is missing.');
