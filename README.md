...
- The inventory includes a paper-doll equipment view beside a visible backpack. Weapons can be dragged from the backpack onto the figure's weapon slot; everyone permanently has a fist, while clothing slots remain available for shoes, pants, shirt, gloves, and hat.
- Left-click an NPC or another player to attack with the equipped weapon. Fists deal ¼ heart; rocks, slingshots, crossbows, pistols, and rifles deal 1, 2, 3, 5, and 7 hearts. Ranged accuracy decreases with distance, animated projectiles remain visible, ammunition is consumed outside God Mode, and an empty weapon automatically falls back through lower-power usable weapons to fists.
- Merchants may sell slingshots, $300–$500 crossbows, 5¢–$5 arrows, $1,000–$3,000 pistols, $3,000–$6,000 rifles, and ammunition at their actual randomized price. Right-click is reserved for contextual actions such as trading, purchasing a base, and God Mode teleporting.
