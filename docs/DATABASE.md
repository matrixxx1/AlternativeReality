...
Character rows also persist the body-heat meter, energy-drink deadlines, the five-minute `Probed` deadline, equipped hat, shirt/jacket, pants/shorts, and renderer-neutral light booleans used by the mutually exclusive offhand slot. Schema initialization adds these columns in place for existing realities.
